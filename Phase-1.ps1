...
<#---------------------
 ...
 Start-Transcript -Path $FP -NoClobber
  ...
  #LIST RUNNING SERIVCES >> #FIXME FOR SOME REASON THIS DOESNT WORK AHHHH
  ...
  Get-Process | Select StartTime,ID,Path,Name | FT
...
#>
  ...
  #AUDIT RUN KEYS >> FIXME This doesnt actually list the contents of the registry booooo
